...
namespace Infrastructure.Migrations
{
    ...
    public partial class newMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Peliculas",
                columns: new[] { "Titulo", "Sinopsis", "Poster", "Trailer", "Genero" },
            ...
            migrationBuilder.InsertData(
                table: "Peliculas",
                columns: new[] { "Titulo", "Sinopsis", "Poster", "Trailer", "Genero" },
                values: new object[] { "En busca de la felicidad",
                              " es un conmovedor drama que sigue la lucha de Chris Gardner, interpretado por Will Smith, por superar la adversidad y lograr el éxito mientras cuida a su hijo. Una historia inspiradora sobre perseverancia y amor." ,
                              "https://pics.filmaffinity.com/the_pursuit_of_happyness-660040804-large.jpg",
